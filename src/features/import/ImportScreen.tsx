    ...
    return (
      <SubScreen title="Import from Spendee">
        <div className="px-4 py-6">
          <label className="flex cursor-pointer flex-col items-center gap-3 rounded-[1.375rem] border-2 border-dashed border-border bg-surface p-10 text-center">
          ...
          <div className="mt-6 rounded-[1.375rem] bg-surface p-4 text-sm text-muted">
  ...
  return (
    <SubScreen title="Review import">
      <div className="px-4 py-4">
        ...
        {/* Column mapping */}
        <div className="space-y-2 rounded-[1.375rem] bg-surface p-3">
        ...
        {/* Options */}
        <div className="mt-3 space-y-2 rounded-[1.375rem] bg-surface p-3">
        ...
        <div className="overflow-x-auto rounded-[1.375rem] border border-border">
        ...
        <div className="mt-5 flex gap-2">
          <button
            ...
            className="rounded-[1.375rem] border border-border px-4 py-3 text-sm font-semibold text-muted"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 rounded-[1.375rem] bg-primary py-3 text-sm font-semibold text-primary-fg disabled:opacity-40"
          >

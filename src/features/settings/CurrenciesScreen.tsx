    ...
    <SubScreen title="Currency & rates">
      <div className="px-4 py-4">
        ...
        <button
          ...
          className="mb-6 flex w-full items-center gap-3 rounded-[1.375rem] bg-surface p-4"
        >
        ...
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-[1.375rem] border border-dashed border-border py-3 text-sm font-medium text-muted"
        >
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={cn(
                'grid w-12 place-items-center rounded-[1.375rem] border border-border text-expense',
              )}
            ...
            <button
              onClick={saveRate}
              className="flex-1 rounded-[1.375rem] bg-primary py-3 text-base font-semibold text-primary-fg"
            >
              Save rate
            </button>
          </div>
